...
import { fetchPorfolio } from './fetch';
...
export const authLogin = (username, password) => {
    return dispatch => {
        dispatch(authStart());
        axios.post('http://django-react-crypto.herokuapp.com/rest-auth/login/', {
            username: username,
            password: password
        })
        .then(res => {
...
export const authSignup = (username, email, password1, password2) => {
    return dispatch => {
        dispatch(authStart());
        axios.post('http://django-react-crypto.herokuapp.com/rest-auth/registration/', {
            username: username,
            email: email,
            password1: password1,
            password2: password2
